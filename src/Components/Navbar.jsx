...
export default function Navbar() {
    ...
    const { name, cartCount } = useContext(AuthContext)
    ...
    return (
        <Box h="15vh" bg="#32aeb1" position="sticky" top="0px" zIndex={2} >
            <Box display="flex" gap={20} paddingTop="30px">
                <Image onClick={() => (navigate("/"))} marginLeft={20} w="15%" src="https://www.netmeds.com/assets/gloryweb/images/home-logo-netmeds-new.svg" alt="logo" />
                ...
                <HStack gap="50px" marginLeft="100px">
                    <Flex onClick={() => (navigate("/cart"))}>
                        ...
                        <Box marginLeft="-15px" h="20px" w="25px" borderRadius="50%" background="#d63384;" color="White"><Center>{cartCount}</Center></Box>
